function p = runTargetSelection(varargin)
...
ip.addParameter('minFixation', .35)
ip.addParameter('fixPreStim', .05)
...
settingsStruct.(sn).rewardForFixation  = 0;
settingsStruct.(sn).shrinkTimeConstant  = 5;


% settingsStruct.(sn).stateFunction.name = 'stimuli.modules.dotselection.runDefaultTrial';
settingsStruct.(sn).stateFunction.name = 'stimuli.modules.targetselection.runGaborsTrial';
...
settingsStruct.(sn).rewardUpdateFun=          @stimuli.modules.targetselection.rewardUpdateSwitchRule;
