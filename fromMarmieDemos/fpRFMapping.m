...
p.defaultParameters.stimulus.fixationXY = [0 0];
...
p.trial.stimulus.motion1.nThetas     =  8;%8 %no specifying defaults to all
...
p.trial.stimulus.motion1.dotLifetime   = .08; % in seconds
...
p.trial.stimulus.showFixationPoint=false;
p.trial.stimulus.followMouse = true;
p.trial.stimulus.followMouseAtTrialOnset = false;
p.trial.stimulus.fixationFollowsMouse = true;
...
p.defaultParameters.stimulus.dotsW  = 8; 
